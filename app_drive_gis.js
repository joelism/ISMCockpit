...
// Konfiguration für Google Drive (deine Daten)
const GD = {
...
async function initDriveGis() {
  if (driveGisInited) return;
...
function renderTabDrive(selected, body) {
  ...
  (async () => {
    try {
      ...
      console.warn(
        "Drive-Client konnte nicht automatisch initialisiert werden:",
        e
      );
    } finally {
      updateStatus();
